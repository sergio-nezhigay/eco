...
function PrimaryButton({
  ...
  return (
    <ScrollLink
      ...
      } md:flex-center group w-fit cursor-pointer  gap-3 rounded-full bg-primary-300 px-4 py-[10px] text-base font-normal leading-[19px] tracking-m4 hover:bg-primary-200 hover:text-primary-300 `}
    >
      {content}
